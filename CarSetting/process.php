<?php
   ...
   $prezzoAlto = isset($_POST['prezzoAlto']) ? htmlentities($_POST['prezzoAlto'], ENT_QUOTES, "UTF-8") : 300000;
   ...
   // echo $carburanti['benzina']." ".$carburanti['diesel']." ".$carburanti['gpl']." ".$carburanti['hybrid']." ".$carburanti['elettrico'];
...
<div class="container-fluid">
    <a class="navbar-brand" href=\'index.php\'>
        <img src="images/logo/logo.svg" class="d-inline-block align-text-top">
            ...
            echo '
                  <div class="card mb-3" style="max-width: 768px;">
                     <div class="row g-0">
                        <div class="col-md-4">
                           <div class="container">
                              <img src = "'.$row['imageurl'].'" class = "search-pic-result">
                           </div>
                           <div class = "container rating-cont">';
                           $query_rating = 'select rating from valutazioni where id in (
                              select idvalutazione from automobili where lower(modello) like "%'.$row['modello'].'%" and lower(brand) like "%'.$row['brand'].'%"
                              )';
                        ...
                        <div class="col-md-8">
                           <div class="card-body">
                              <h5 class="card-title">'.$row['brand']." ".$row['modello'].'</h5>
                              <p class="card-text"><strong>Prezzo:</strong> '.$row['prezzolistino'].'€</p>
                              <p class="card-text"><strong>Velocità max:</strong> '.$row['velocita'].'</p>
                              <form method = "post" action="./vista.php">
                                 <input type="hidden" name="scopriBrand" value = "'.$row['brand'].'">
                                 <input type="hidden" name="scopriAuto" value = "'.$row['modello'].'">
